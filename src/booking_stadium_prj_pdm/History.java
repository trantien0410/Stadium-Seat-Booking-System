...
public class History extends javax.swing.JFrame {
    ...
    private void btnShowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnShowActionPerformed
        ...
        try (Connection con = DriverManager.getConnection(connectionUrl); java.sql.Statement stmt = con.createStatement();) {
            String SQL = "select t.team1,t.team2 , b.quantity,t.price, (t.price* b.quantity) as total_payment , b.booking_date, b.type_payment, t.ticket_type from ticket as t join booking as b on t.ticket_id = b.ticket_id join user as u on u.cus_id = b.cus_id where u.cus_gmail='"+user+"' ;";
